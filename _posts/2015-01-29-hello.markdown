...
一直想建一个个人博客，可是一直拖延。最近不想复习，实验室也不太想搬砖。自学的任务完成以后开始着手，github八月份建的账号一直没用过，自己小白一个，githubdesktop各种难用，各种warning,error
断断续续两三天算基本搭好。之后再完善。感谢Hux提供的主题
要学一下用markdown  jupyterbook  幻灯片到底怎么演示我的天

然后写博文的时候添加图片要自己建个位置
学一下git

不懂为什么我一改日期它主页上就就显示不了
